      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <form method="POST" action="painel/addCode">
              <label class="form-control">Crie o seu codigo e convide amigos ! Ganhe promoções para si e para seu amigo!</label>
              <?php if($codigo != null){ ?>
                <label class="form-control">Seu codigo é: <?php echo $codigo?></label>
              <?php }else{?>
                <input placeholder="Ex: tiagodasbets" class="form-control" type="text" name="codigo">
